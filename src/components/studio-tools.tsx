...
// The questions guests actually email about. Offering drafts beats an empty
// box: most couples edit a sentence, few write one from nothing.
const FAQ_STARTERS: { question: string; answer: string }[] = [
  {
